...
public class Raza {
	...
	public Raza(int codigo, String raza_ganado, int numero, String fecha, String zonas) {
		super();
		this.codigo = codigo;
	...
	public String toString() {
		return "Raza [codigo=" + codigo + ", raza_ganado=" + raza_ganado + ", numero=" + numero + ", fecha=" + fecha
				+ ", zonas=" + zonas + "]";
	}
