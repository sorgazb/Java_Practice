...
public class EjercicioBocadillos {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch(opcion) {
			case 'a':
				cuenta=cuenta+BOCADILLO_JAMON;
				cantidadJamon++;
				break;
			case 'b':
				cuenta=cuenta+BOCADILLO_QUESO;
				cantidadQueso++;
				break;
			case 'c':
				cuenta=cuenta+BOCADILLO_MIXTO;
				cantidadMixto++;
				break;
			case 'd':
				cuenta=cuenta+BOCADILLO_VEGETAL;
				cantidadVegetal++;
				break;
			case 'e':
